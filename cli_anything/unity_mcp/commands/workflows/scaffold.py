"""Workflow scaffold commands: sandbox-scene, bootstrap-guidance, validate-scene, wire-reference, create-prefab, reset-scene, create-behaviour, audit-advanced."""
...
workflow_group.add_command(workflow_bootstrap_guidance_command)
workflow_group.add_command(workflow_create_sandbox_scene_command)
workflow_group.add_command(workflow_create_behaviour_command)
workflow_group.add_command(workflow_reset_scene_command)
workflow_group.add_command(workflow_audit_advanced_command)
workflow_group.add_command(workflow_wire_reference_command)
workflow_group.add_command(workflow_create_prefab_command)
workflow_group.add_command(workflow_validate_scene_command)
